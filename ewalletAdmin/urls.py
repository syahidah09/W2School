...
urlpatterns = [   
    ...
    #  Student CBV
    path('student_create/<int:pk>/', views.StudentCreateView2, name='student-create'),
    path('students/', views.StudentListView2, name='students'),
    ...
    path('parents/', views.ParentListView2, name='parents'),
    ...
    path('transactions/', views.TransactionListView2, name='transactions'),
    ...
    path('products/', views.ProductListView2, name='products'),
    ...
    #  Order CBV
    path('orders/', views.OrderListView2, name='orders'),
